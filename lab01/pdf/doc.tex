...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=0.7\textwidth]{battery_over_time_gps.png}
...
% \begin{itemize}
%     \item \textbf{Initial Battery Level:} \%
%     \item \textbf{Battery Level after 4 hours:} \%
%     \item \textbf{Total Drain:} \%
% \end{itemize}


% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=0.7\textwidth]{battery_over_time_cellular.png}
%     \caption{Battery drain comparison over 4 hours for GPS and Cellular locators.}
